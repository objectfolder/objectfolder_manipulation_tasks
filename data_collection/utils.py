...
ee_gap = 0 # 0.20045875 # 0.14462573 for grasping # 0.20045875 for one finger
...
class Camera:
    def __init__(self, pb, cameraResolution=[320, 240], cam_pos=[0.381, 0.002, 0.15], angle=[50, 0, 0], cam_dis = 0.4):
        self.cameraResolution = cameraResolution

        camTargetPos = cam_pos #[0.381, 0.002, 0.15] #[0.381, 0.002, 0.15]
        camDistance = cam_dis
        upAxisIndex = 2
