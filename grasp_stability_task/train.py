...
parser.add_argument("-log_dir", type=str, help="number of datapoints")
parser.add_argument("-model_dir", type=str, help="number of datapoints")
parser.add_argument("-obj_name", type=str, help="number of datapoints")
...
class Learning:
    ...
    def load_data(self, K, i):
        ...
        rootDir = "data/grasp/" + args.obj_name 
        ...
        trainIdx = list(set(idx) - set(testIdx)) #-set(redudant))
        ...
        trainLoader = torch.utils.data.DataLoader(
            trainDataset, batch_size=64, shuffle=True, num_workers=12, pin_memory=True
        )
        ...
        testLoader = torch.utils.data.DataLoader(
            testDataset, batch_size=64, shuffle=False, num_workers=12, pin_memory=True
        )
...
def test(fields):
    ...
    for i in range(K):
        ...
        lossTrainList, accTestList = learner.train(6)
        ...
        modelDir = args.model_dir #"models/grasp2_2"
