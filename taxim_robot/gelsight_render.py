...
conf = {
    'background_path': os.path.join(gelsight_path, "gelsight_data/0.png"),
...
class gelsightRender:
    ...
    def __init__(self):
        ...
        # TODO: change the background after calibration
        #TODO: I need to generate that weird image as well, that np array is int64
        # self.real_bg = cv2.rotate(self.real_bg, cv2.ROTATE_90_CLOCKWISE)
